      ...
      <div className="pt-8 md:pt-0 pb-8 md:pb-24 flex flex-col gap-8 md:gap-12 lg:gap-16 items-center justify-center">
        ...
        <div className="flex flex-col gap-8 text:md md:text-lg font-medium text-justify">
          <div>
            ...
            understanding rental agreements, there's a lot to consider.
          ...
          <div>
            ...
            essential services. Having a clear vision of what you're looking for
          ...
          <div>
            3. Attend Open Houses and Inspections: Once you've identified
            ...
            property's condition, layout, and surroundings. Take note of any red
            flags or deal-breakers and don't hesitate to ask questions about the
          ...
          <div>
            ...
            lease duration. If anything seems unclear or unreasonable, don't
          ...
          <div>
            ...
            Research the neighborhood's safety, accessibility to public
          ...
          <div>
            6. Seek Professional Advice: If you're new to the rental market or
            feeling overwhelmed, don't hesitate to seek advice from
