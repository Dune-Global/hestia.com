import { registerSchemaStudent } from "@/helpers/validation/student/auth";
...
import { registerStudent } from "@/helpers/api/student/auth";
...
export const StudentRegisterForm = (props: Props) => {
  ...
  const form = useForm<z.infer<typeof registerSchemaStudent>>({
  ...
  async function onSubmit(values: z.infer<typeof registerSchemaStudent>) {
    try {
      setIsLoading(true);
